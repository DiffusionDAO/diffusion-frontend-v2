...
import DEFAULT_TOKEN_LIST from '../../config/constants/tokenLists/bnb-default.tokenlist.json'
import UNSUPPORTED_TOKEN_LIST from '../../config/constants/tokenLists/bnb-unsupported.tokenlist.json'
import WARNING_TOKEN_LIST from '../../config/constants/tokenLists/bnb-warning.tokenlist.json'
