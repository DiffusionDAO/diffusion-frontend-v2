...
export const DEFAULT_META: PageMeta = {
  title: 'Diffusion',
  description:
    'The most popular AMM on BNB by user count! Earn CAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by Diffusion), NFTs, and more, on a platform you can trust.',
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/bnb-squad': { basePath: true, title: t('Diffusion Squad') },
      '/pottery': { basePath: true, title: t('Pottery') },
    },
    defaultTitleSuffix: t('Diffusion'),
  }
}
