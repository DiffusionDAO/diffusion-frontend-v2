...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c0:hover:not(:disabled):not(.diffusion-button--disabled):not(.diffusion-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c0:active:not(:disabled):not(.diffusion-button--disabled):not(.diffusion-button--disabled) {
      opacity: 0.85;
