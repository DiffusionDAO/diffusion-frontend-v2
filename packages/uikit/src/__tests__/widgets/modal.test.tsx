...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c6:hover:not(:disabled):not(.diffusion-button--disabled):not(.diffusion-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c6:active:not(:disabled):not(.diffusion-button--disabled):not(.diffusion-button--disabled) {
      opacity: 0.85;
