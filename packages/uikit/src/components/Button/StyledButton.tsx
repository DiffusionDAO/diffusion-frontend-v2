...
const StyledButton = styled.button<BaseButtonProps>`
  ...
  &:hover:not(:disabled):not(.diffusion-button--disabled):not(.diffusion-button--disabled):not(:active) {
    opacity: 0.65;
  }

  &:active:not(:disabled):not(.diffusion-button--disabled):not(.diffusion-button--disabled) {
    opacity: 0.85;
